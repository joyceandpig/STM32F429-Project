...
// 	GPIO_AF_Set(GPIOC,11,13);	//PC11,AF13 DCMI_D4  
	...
	ov5640_GPIO_Handler.Pin = GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_11;
	ov5640_GPIO_Handler.Mode = GPIO_MODE_AF_PP;
	ov5640_GPIO_Handler.Pull = GPIO_PULLUP;
	ov5640_GPIO_Handler.Speed = GPIO_SPEED_FREQ_HIGH;
	ov5640_GPIO_Handler.Alternate = GPIO_AF13_DCMI;
	HAL_GPIO_Init(GPIOC, &ov5640_GPIO_Handler);//复用功能输出
...
// 	GPIO_AF_Set(GPIOC,11,12);	//PC11,AF12 
	...
	ov5640_GPIO_Handler.Pull = GPIO_PULLUP;
	ov5640_GPIO_Handler.Speed = GPIO_SPEED_FREQ_HIGH;
	ov5640_GPIO_Handler.Alternate = GPIO_AF12_SDIO;
	HAL_GPIO_Init(GPIOC, &ov5640_GPIO_Handler);//复用功能输出	
} 
//得到文件名,按文日期时间命名
