...
{
{"淞幸F429/746开发平台","淞幸F429/746開發平臺","SUNSHEEN F429/746 Develop Kit.",},
...
void sysset_system_about(u16 x,u16 y,u8*caption)
{
  	...
  	if(twin!=NULL&&rbtn!=NULL)
	{
		...
		strcat((char*)tbuf,(const char*)verbuf);
 		...
 		gui_show_string("成都淞幸科技有限责任公司",x+10,y+32+34+20*2,180,12,12,BLACK);//显示信息
 		gui_show_string("www.sunsheen.cn",x+10,y+32+34+20*3,180,12,12,BLACK);//显示信息
