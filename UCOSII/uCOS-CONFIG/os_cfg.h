...
#ifndef	EVENTS_MAX
	#define EVENTS_MAX				20u		
#endif

#ifndef	TIMER_MAX
	#define TIMER_MAX       		16u		
#endif

#ifndef	MSG_QUEUE_MAX
	#define MSG_QUEUE_MAX			4u		
#endif

#ifndef	TASKS_MAX
	#define TASKS_MAX				20u		
#endif

#ifndef	OS_TICK_RATE_HZ
...
#define OS_MAX_EVENTS             EVENTS_MAX//20u   /* Max. number of event control blocks in your application      */
...
#define OS_MAX_QS                 MSG_QUEUE_MAX//4u   /* Max. number of queue control blocks in your application      */
#define OS_MAX_TASKS              TASKS_MAX//20u   /* Max. number of tasks in your application, MUST be >= 2       */
...
#define OS_TMR_CFG_MAX            TIMER_MAX//16u   /*     Maximum number of timers                                 */
#define OS_TMR_CFG_NAME_EN        1u   /*     Determine timer names                                    */
#define OS_TMR_CFG_WHEEL_SIZE     8u   /*     Size of timer wheel (#Spokes)                            */
#define OS_TMR_CFG_TICKS_PER_SEC  OS_TICK_RATE_HZ/*100u*/   /*     Rate at which timer management task runs (Hz)            */
