...
#define TOUCH_PEN_GPIO_PIN           		 GPIO_PIN_7
#define TOUCH_DOUT_GPIO_PIN          	 	 GPIO_PIN_3
#define TOUCH_TDIN_GPIO_PIN           	 GPIO_PIN_3
#define TOUCH_TCLK_GPIO_PIN           	 GPIO_PIN_6
#define TOUCH_TCS_GPIO_PIN          		 GPIO_PIN_8
...
////IO操作函数											   
#define	TDIN_SET()     HAL_GPIO_WritePin(TOUCH_DIN_CS_GPIO_PORT, TOUCH_TDIN_GPIO_PIN, GPIO_PIN_SET) //SCL	 GPIO_PIN_SET 
#define	TDIN_CLEAR()   HAL_GPIO_WritePin(TOUCH_DIN_CS_GPIO_PORT, TOUCH_TDIN_GPIO_PIN, GPIO_PIN_RESET) //SCL

#define	TCLK_SET()     HAL_GPIO_WritePin(TOUCH_PEN_CLK_GPIO_PORT, TOUCH_TCLK_GPIO_PIN, GPIO_PIN_SET) //SCL	 
#define	TCLK_CLEAR()   HAL_GPIO_WritePin(TOUCH_PEN_CLK_GPIO_PORT, TOUCH_TCLK_GPIO_PIN, GPIO_PIN_RESET) //SCL

#define	TCS_SET()     HAL_GPIO_WritePin(TOUCH_DIN_CS_GPIO_PORT, TOUCH_TCS_GPIO_PIN, GPIO_PIN_SET) //SCL	 
#define	TCS_CLEAR()   HAL_GPIO_WritePin(TOUCH_DIN_CS_GPIO_PORT, TOUCH_TCS_GPIO_PIN, GPIO_PIN_RESET) //SCL

#define	PEN()     	HAL_GPIO_ReadPin(TOUCH_PEN_CLK_GPIO_PORT, TOUCH_PEN_GPIO_PIN) //SDA	  
#define	DOUT()      HAL_GPIO_ReadPin(TOUCH_DOUT_GPIO_PORT, TOUCH_DOUT_GPIO_PIN) //SDA	
