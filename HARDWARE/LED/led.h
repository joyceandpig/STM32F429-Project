...
#define LED0_STA_TURN()  HAL_GPIO_TogglePin(LED_GPIO_GPIO_PORT, LED_0_GPIO_PIN)//端口翻转
...
#define LED1_STA_TURN()  HAL_GPIO_TogglePin(LED_GPIO_GPIO_PORT, LED_1_GPIO_PIN)//端口翻转
