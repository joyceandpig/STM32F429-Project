...
////IO操作函数											   
#define	W25QXX_CS_SET()     HAL_GPIO_WritePin(W25QXX_CS_GPIO_PORT, W25QXX_CS_GPIO_PIN, GPIO_PIN_SET) //SCL, GPIO_PIN_SET	 
#define	W25QXX_CS_CLEAR()   HAL_GPIO_WritePin(W25QXX_CS_GPIO_PORT, W25QXX_CS_GPIO_PIN, GPIO_PIN_RESET) //SCL, GPIO_PIN_RESET
