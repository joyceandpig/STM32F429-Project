...
////IO操作函数											   
#define	SCCB_SCL_SET()     HAL_GPIO_WritePin(SCCB_GPIO_SCL_PORT, SCCB_SCL_GPIO_PIN_NUM, GPIO_PIN_SET) //SCL	 
#define	SCCB_SCL_CLEAR()   HAL_GPIO_WritePin(SCCB_GPIO_SCL_PORT, SCCB_SCL_GPIO_PIN_NUM, GPIO_PIN_RESET) //SCL

#define	SCCB_SDA_SET()     HAL_GPIO_WritePin(SCCB_GPIO_SCL_PORT, SCCB_SDA_GPIO_PIN_NUM, GPIO_PIN_SET) //SDA	  
#define	SCCB_SDA_CLEAR()   HAL_GPIO_WritePin(SCCB_GPIO_SCL_PORT, SCCB_SDA_GPIO_PIN_NUM, GPIO_PIN_RESET) //SDA	 

#define	SCCB_READ_SDA_STA()    HAL_GPIO_ReadPin(SCCB_GPIO_SCL_PORT, SCCB_READ_SDA_GPIO_PIN_NUM) //输入SDA 	
